...
GLfloat Terrain::vertices[] = {
	// Positions       // Normals           // Texture Coords
	-50.f,  0.f, -50.f,  0.0f,  1.0f,  0.0f,  0.0f,  36.0f,
	 50.f,  0.f, -50.f,  0.0f,  1.0f,  0.0f,  36.0f,  36.0f,
	 50.f,  0.f,  50.f,  0.0f,  1.0f,  0.0f,  36.0f,  0.0f,
	 50.f,  0.f,  50.f,  0.0f,  1.0f,  0.0f,  36.0f,  0.0f,
	-50.f,  0.f,  50.f,  0.0f,  1.0f,  0.0f,  0.0f,  0.0f,
	-50.f,  0.f, -50.f,  0.0f,  1.0f,  0.0f,  0.0f,  36.0f
};

Terrain::Terrain(Material* material, Camera* camera, std::vector<LightsManager::PointLight>& plights, std::vector<LightsManager::SpotLight>& slights) : plights_(plights), slights_(slights) {
	material_ = material;
...
void Terrain::GetUniformLocations() {
